...
Welcome to `opensemantic.demo.lab` contributor's guide.
...
If you experience bugs or general issues with `opensemantic.demo.lab`, please have a look
...
You can help improve `opensemantic.demo.lab` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`opensemantic.demo.lab` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `opensemantic.demo.lab`'s files. While this mechanism can
...
```
conda create -n opensemantic.demo.lab python=3 six virtualenv pytest pytest-cov
conda activate opensemantic.demo.lab
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/opensemantic.demo.lab.git
   cd opensemantic.demo.lab
   ```
...
5. Install [pre-commit]:
   ...
   `opensemantic.demo.lab` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/opensemantic.demo.lab
[issue tracker]: https://github.com/<USERNAME>/opensemantic.demo.lab/issues
